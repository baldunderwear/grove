...
**Plans:** 4 plans
Plans:
- [ ] 08-01-PLAN.md — Updater plugin backend: Rust registration, tauri.conf.json config, release profile optimization
- [ ] 08-02-PLAN.md — Keyboard shortcuts, version bump to 1.0.0, MIT LICENSE
