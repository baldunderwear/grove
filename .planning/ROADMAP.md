...
- [ ] **Phase 14: Toast System + Launch Path Cleanup** - In-app toast notifications and removal of external launch infrastructure
...
**Success Criteria** (what must be TRUE):
  1. User sees a toast notification when a session changes state (waiting/idle/error) without leaving the current view
  2. User can click a toast to navigate directly to the relevant session tab
