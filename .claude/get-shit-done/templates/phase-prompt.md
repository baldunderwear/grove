...
<!-- For checkpoint task examples and patterns, see @Z:/data/development/forge/.claude/get-shit-done/references/checkpoints.md -->
...
See `Z:/data/development/forge/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `Z:/data/development/forge/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `Z:/data/development/forge/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
