...
See Z:/data/development/forge/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using Z:/data/development/forge/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using Z:/data/development/forge/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from Z:/data/development/forge/.claude/get-shit-done/templates/discovery.md
...
Use Z:/data/development/forge/.claude/get-shit-done/templates/discovery.md.
