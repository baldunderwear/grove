...
<execution_context>
@Z:/data/development/forge/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @Z:/data/development/forge/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
