...
<execution_context>
@Z:/data/development/forge/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @Z:/data/development/forge/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
