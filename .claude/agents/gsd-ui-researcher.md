...
Use template from `Z:/data/development/forge/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `Z:/data/development/forge/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "Z:/data/development/forge/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
