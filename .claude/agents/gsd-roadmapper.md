...
Reference full template: `Z:/data/development/forge/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `Z:/data/development/forge/.claude/get-shit-done/templates/state.md`.
