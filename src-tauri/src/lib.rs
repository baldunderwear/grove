...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::config_commands::add_profile,
            commands::config_commands::update_profile,
            commands::config_commands::remove_profile,
            commands::config_commands::set_project_profile,
